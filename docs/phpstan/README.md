...
=======
# Documentazione PHPStan per il Modulo Job

## Introduzione

Questa cartella contiene la documentazione relativa all'analisi statica del codice effettuata con PHPStan sul modulo Job.
