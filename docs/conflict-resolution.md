...
- [Documentazione Generale Risoluzione Conflitti](../../../project_docs/conflict_resolution_summary.md)
- [Documentazione Specifica del Modulo](../../project_docs/risoluzione_conflitti_git.md)
